...
/** Parse stored date strings, handling YYYY-MM-DD keys safely. */
...
export class StatisticsForm extends Form {
      ...
      Section(
        {
          id: "details",
          footer:
            "Bugs and Suggestions? Inkdex Discord -> #other-repos -> KakorotExtension Support Thread.",
        },
        [
  ...
  async handleReset(): Promise<void> {
    throw new FormConfirmationError(
      ...
      "Reset all Hitomi statistics? This cannot be undone.",
    );
  }
...
class RemoveSpecificStatsForm extends Form {
      ...
      Section(
        {
          id: "select",
          footer:
            "Select The Stat Categories You Want To Reset. This Cannot Be Undone.",
        },
        [
  ...
  async handleFinalConfirm(): Promise<void> {
    throw new FormConfirmationError(
      ...
      "Remove the selected Hitomi statistics?",
    );
  }
...
class ContentStatsForm extends Form {
  ...
  override getSections(): FormSectionElement<unknown>[] {
    ...
    const pageSectionItems: (FormItemElement<unknown> | undefined)[] = [
