...
import { SearchResultItem, DiscoverSectionItem } from "@paperback/types";

export function parseSearch($: CheerioAPI, collectedIds: string[], baseUrl: string): SearchResultItem[] {
...
export function parsePopular($: CheerioAPI, collectedIds: string[], baseUrl: string): DiscoverSectionItem[] {
...
export function parseNewReleases($: CheerioAPI, collectedIds: string[], baseUrl: string): DiscoverSectionItem[] {
