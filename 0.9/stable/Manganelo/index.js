...
var source = (() => {
  ...
  __export(main_exports, {
    MangaNeloExtension: () => MangaNeloExtension,
    Manganelo: () => Manganelo
  });
  init_buffer();
  ...
  var MangaNeloExtension = class {
    ...
    async getSearchResults(query, metadata) {
      ...
      const searchUrl = new URLBuilder(baseUrl).addPath("advanced_search").addQuery("s", "all").addQuery("page", page.toString()).addQuery("keyw", query.title).build();
      const request = {
        url: searchUrl,
        method: "GET"
      };
  ...
  var Manganelo = new MangaNeloExtension();
